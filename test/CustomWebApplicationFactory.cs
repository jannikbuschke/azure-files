...
namespace AzFiles.Test
{
      ...
      : WebApplicationFactory<TEntryPoint> where TEntryPoint : class
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            //var cs = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=AzFiles-test;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            //var options = new DbContextOptionsBuilder { };
            //options.UseSqlServer(cs, options =>
            //{
            //    options.MigrationsAssembly("AzFiles.Core.SqlServer");
            //});
