...
export type QueryInputs = {
  ...
  "/api/features/gallery/get-dynamic-gallery": AzFiles_Features_Gallery.GetDynamicGallery,
...
export type QueryOutputs = {
  ...
  "/api/features/gallery/get-dynamic-gallery": Microsoft_FSharp_Core.FSharpResult<AzFiles_Features_Gallery.GalleryViewmodel,AzFiles.ApiError>,
